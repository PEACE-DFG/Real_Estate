     <!-- Footer Start -->
     <div class="container-fluid bg-dark text-white-50 footer pt-5 mt-5 mb-0  wow fadeIn" data-wow-delay="0.1s">
            ...
            <div class="container-fluid bg-dark text-white-50 mt-0">
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-12 text-center text-md-center mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="#">XXXXXXXXXXXXXXXXXXXXXXX</a>, All Right Reserved. 
